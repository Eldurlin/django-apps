...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """ Method was_published_recently() returns False for questions whose pub_date is in the future. """
    ...
    def test_was_published_recently_with_old_question(self):
        """ Method was_published_recently() returns False for questions whose pub_date is older than 1 day. """
    ...
    def test_was_published_recently_with_recent_question(self):
        """ Method was_published_recently returns True for questions whose pub_date is within the last day. """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_questions(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response['latest_question_list'], ['<Question: Past question.>'])
